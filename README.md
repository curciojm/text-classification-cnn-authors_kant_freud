...
**Updated version**: This repository contains an earlier version of the project. The current version includes TensorFlow Serving, Docker, a Django web interface, and deployment on Railway.
